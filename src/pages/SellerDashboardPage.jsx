...
function SellerDashboardPage({ auctions, onAuctionUpdate, addNotification }) {
  ...
  const handleConfirmClose = () => {
    if (!selectedAuctionToClose || !onAuctionUpdate) return

    const closedAuction = {
      ...selectedAuctionToClose,
      status: 'ENDED',
      endTime: Date.now(),
    }

    onAuctionUpdate(closedAuction)
    addNotification?.({
      type: 'CLOSED',
